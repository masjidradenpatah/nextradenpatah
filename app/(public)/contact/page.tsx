...
const Page = () => {
  return (
    <div
      className={
        "mt-32 flex size-full flex-col items-center gap-6 overflow-hidden px-4 py-32 sm:gap-12 md:gap-24 lg:px-0"
      }
    >
      <SectionTitle
        title={"Kontak Kami"}
      ...
      />
      <section data-testid="contact-section" className={"relative w-full p-4"}>
        <div
          className={
